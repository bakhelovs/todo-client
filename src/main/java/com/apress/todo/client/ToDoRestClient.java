...
import com.apress.todo.ToDoRestClientProperties;
...
public class ToDoRestClient {
    ...
    // основной класс для синхронного HTTP-доступа. Отвечает за установление HTTP-соединений
    ...
    public Iterable<ToDo> findAll() throws URISyntaxException {
        ...
        ResponseEntity<Iterable<ToDo>> response = restTemplate.exchange(requestEntity, new ParameterizedTypeReference<>() {
        });
